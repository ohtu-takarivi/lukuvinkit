Feature: After logging in, I can create tips with valid information
  ...
  Scenario: user can create a tip with valid information
    ...
    Then new book tip with title "Best Title" and type "books" and description "Super description" and url "www.mustread.com" and author "John Doe" is created
  ...
  Scenario: user can't create a tip without url
    Given test user is logged in
    When title "Good title" and type "books" and description "I wonder" and no url and author "John Doe" are given
    Then new book tip with "Bad title" and "I wonder" is not created 

  Scenario: user can't create a tip without author
    Given test user is logged in
    When title "Good title" and type "books" and description "I wonder" and url "www.nobleeffort.com" and no author are given
    Then new book tip with "Bad title" and "I wonder" is not created 
