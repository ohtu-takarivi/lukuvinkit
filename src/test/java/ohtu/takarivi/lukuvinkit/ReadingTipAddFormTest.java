...
public class ReadingTipAddFormTest {
    ...
    public void ReadingTipAddFormBook() {
        ...
        assertEquals(rt, new ReadingTip("title", ReadingTipCategory.BOOK, "description", "", "author", "978-3-16-148410-0", cu));
    }
    @Test
    public void ReadingTipAddFormLink() {
        ...
        CustomUser cu = new CustomUser("user", "password", "name");
        ReadingTip rt = rtaf.createReadingTip(cu);
        assertEquals(rt, new ReadingTip("title", ReadingTipCategory.LINK, "description", "URL", "author", "", cu));
    }
    @Test
    public void ReadingTipAddFormVideo() {
        ...
        CustomUser cu = new CustomUser("user", "password", "name");
        ReadingTip rt = rtaf.createReadingTip(cu);
        assertEquals(rt, new ReadingTip("title", ReadingTipCategory.VIDEO, "description", "URL", "author", "", cu));
    }
    @Test
    public void ReadingTipAddFormArticle() {
        ...
        CustomUser cu = new CustomUser("user", "password", "name");
        ReadingTip rt = rtaf.createReadingTip(cu);
        assertEquals(rt, new ReadingTip("title", ReadingTipCategory.ARTICLE, "description", "", "author", "", cu));
    }
